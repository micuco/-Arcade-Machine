...
void Lab3_Vis2D::OnInputUpdate(float deltaTime, int mods)
{
    ...
    float cx = logicSpace.x + logicSpace.width / 2.0f;
    float cy = logicSpace.y + logicSpace.height / 2.0f;
    ...
    if (window->KeyHold(GLFW_KEY_Z)) {
        ...
        logicSpace.x = cx - logicSpace.width / 2.0f;
        logicSpace.y = cy - logicSpace.height / 2.0f;
    }
